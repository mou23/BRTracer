...
public class BugSimilarity {
	...
	public BugSimilarity() {
		wordCount = Property.getInstance().BugTermCount;
		bugReportCount = Property.getInstance().BugReportCount;
	...
	public void computeSimilarity() throws IOException {
		...
		for (int i = bugReportCount-1; i < bugReportCount; i++) {
			int firstId = idArr[i];
