...
public class BugVector {
	...
	private String BUG_CORPUS_FOLDER;
	
	public BugVector() {
		HOME_FOLDER = Property.getInstance().WorkDir + Property.getInstance().Separator;
		BUG_CORPUS_FOLDER = "BugCorpus" + Property.getInstance().Separator;
	}
	...
	public void create() throws WVToolException, IOException {
		...
		System.out.println(HOME_FOLDER + BUG_CORPUS_FOLDER);
