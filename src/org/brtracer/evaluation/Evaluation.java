...
public class Evaluation {
	...
	private String recommandedPath;
	...
	public Evaluation() {
		try {
			workDir = Property.getInstance().WorkDir + Property.getInstance().Separator;
			fileCount = Property.getInstance().FileCount;
			bugCount = Property.getInstance().BugReportCount;
			originfilecount = Property.getInstance().OriginFileCount;
			recommandedPath =  Property.getInstance().WorkDir + Property.getInstance().Separator+ "recommended" +Property.getInstance().Separator;
			
			a = CodeCorpusCreator.spiltclass;
			b = LenScore_OriginClass.B;
			outputFile = Property.getInstance().OutputFile;
			alpha = 0.3f;
			lineSparator = Property.getInstance().LineSeparator;
