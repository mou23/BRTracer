...
public class Similarity {
	Hashtable<String, Integer> fileIdTable;
	...
	public Similarity() throws IOException {
		...
		codeTermCount = Property.getInstance().WordCount;
	}
	...
	public void compute() throws IOException {
		...
		int counter = 0;
		int bugReportCount = Property.getInstance().BugReportCount;
